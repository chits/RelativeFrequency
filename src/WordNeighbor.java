...
public class WordNeighbor implements Writable,WritableComparable<WordNeighbor> {
    ...
    public WordNeighbor(Text word, Text neighbor) {
        this.word = word;
        this.neighbor = neighbor;
    }

    public WordNeighbor(String word, String neighbor) {
    ...
    @Override
    public int compareTo(WordNeighbor other) {
    ...
    public static WordNeighbor read(DataInput in) throws IOException {
        WordNeighbor wordPair = new WordNeighbor();
    ...
    public boolean equals(Object o) {
        ...
        WordNeighbor wordPair = (WordNeighbor) o;
